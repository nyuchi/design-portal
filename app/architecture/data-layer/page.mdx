...
import { SEED_LOCAL_DATA_LAYER, SEED_CLOUD_LAYER, SEED_DATA_OWNERSHIP_RULES } from '@/lib/architecture'
...
<div className="mt-8 grid gap-6 sm:grid-cols-2">
  {SEED_LOCAL_DATA_LAYER.map((tech) => (
    <Card key={tech.name}>
      <CardHeader>
...
<div className="mt-8 overflow-x-auto rounded-xl border border-border">
  <table className="w-full text-sm">
    ...
    <tbody>
      {SEED_DATA_OWNERSHIP_RULES.map((rule) => (
