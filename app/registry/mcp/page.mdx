---
title: "MCP Server — mukoko registry"
description: "Model Context Protocol server for AI assistant integration with the Mukoko Registry."
---
...
OPTIONS https://registry.mukoko.com/mcp — CORS preflight
```
