---
title: "Consuming — mukoko registry"
description: "How to install and use Mukoko Registry components in your application."
---
...
npx shadcn@latest add https://registry.mukoko.com/api/v1/ui/use-mobile
```
