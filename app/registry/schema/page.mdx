---
title: "Schema — mukoko registry"
description: "Registry JSON schema reference for the Mukoko component registry."
---

# Schema

The Mukoko Registry uses a JSON schema based on the [shadcn registry schema](https://ui.shadcn.com/schema/registry.json). This document details the schema structure and item types.
