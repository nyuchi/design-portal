...
The Nyuchi Design Portal is fully compatible with the **shadcn CLI**. You can install any of the **294 registry items** directly into your project with a single command.
