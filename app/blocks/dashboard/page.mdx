---
title: "Dashboard Block — mukoko registry"
...
npx shadcn@latest add \
  ...
  https://registry.mukoko.com/api/v1/ui/tabs
```
...
See the [Dashboard pattern](/patterns/dashboard) for detailed mobile guidelines.
