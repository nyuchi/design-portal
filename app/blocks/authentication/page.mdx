---
title: "Authentication Block — mukoko registry"
...
npx shadcn@latest add \
  ...
  https://registry.mukoko.com/api/v1/ui/separator
```
...
- Use a single "Full name" field, not first/last — see [Inclusive Language](/content/inclusive-language)
...
- Form validation uses `react-hook-form` with `zod` — see the [Authentication pattern](/patterns/authentication)
