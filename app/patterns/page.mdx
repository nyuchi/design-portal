  ...
  <div className="mx-auto max-w-4xl">
    <div className="mb-12 text-center">
      ...
      <p className="mx-auto mt-4 max-w-2xl text-sm text-muted-foreground sm:text-base">
        ...
        they ensure consistency, resilience, and maintainability across all
        17 mukoko mini-apps and 7 nyuchi enterprise products. Each pattern
        is tested against the four pillars: sovereignty, resilience,
        accessibility, and African-first infrastructure.
      </p>
    </div>
    ...
    <div className="mt-12 rounded-2xl border border-border bg-secondary/30 p-6">
      <p className="text-center text-sm text-muted-foreground">
        These patterns are enforced across all 17 mukoko mini-apps
        operating in three modes —{" "}
        <span className="font-medium text-foreground">musha</span> (home),{" "}
        <span className="font-medium text-foreground">basa</span> (work),{" "}
        <span className="font-medium text-foreground">nhaka</span> (heritage)
        {" "}— and all 7 nyuchi enterprise products including{" "}
        <span className="font-medium text-foreground">weather</span>,{" "}
        <span className="font-medium text-foreground">news</span>,{" "}
        <span className="font-medium text-foreground">nhimbe</span>, and{" "}
