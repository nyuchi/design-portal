...
<div className="mt-6 grid gap-4 sm:grid-cols-3">
  {Object.entries(SEED_TYPOGRAPHY_FONTS).map(([key, font]) => (
...
<div className="mt-6 grid gap-3 sm:grid-cols-2">
  {Object.entries(SEED_RADII).map(([name, value]) => (
...
<div className="mt-6 space-y-4">
  <div className="rounded-xl border border-border p-4">
    <p className="font-medium text-foreground">{SEED_ACCESSIBILITY.standard}</p>
    <p className="mt-1 text-sm text-muted-foreground">{SEED_ACCESSIBILITY.contrastDescription}</p>
  </div>
  <div className="rounded-xl border border-border p-4">
    <p className="font-medium text-foreground">{SEED_ACCESSIBILITY.minTouchTarget}px Touch Targets</p>
    <p className="mt-1 text-sm text-muted-foreground">
      All interactive elements must be at least {SEED_ACCESSIBILITY.minTouchTarget}px in both dimensions.
    </p>
  </div>
  <div className="rounded-xl border border-border p-4">
    <p className="font-medium text-foreground">Focus Indicators</p>
    <p className="mt-1 text-sm text-muted-foreground">{SEED_ACCESSIBILITY.focusIndicator}</p>
  </div>
  <div className="rounded-xl border border-border p-4">
    <p className="font-medium text-foreground">Keyboard Navigation</p>
    <p className="mt-1 text-sm text-muted-foreground">{SEED_ACCESSIBILITY.keyboardNavigation}</p>
  </div>
  <div className="rounded-xl border border-border p-4">
    <p className="font-medium text-foreground">Screen Readers</p>
    <p className="mt-1 text-sm text-muted-foreground">{SEED_ACCESSIBILITY.screenReaders}</p>
  </div>
</div>
...
<ul className="mt-3 space-y-2">
  {SEED_VOICE_AND_TONE.principles.map((p) => (
...
<div className="mt-6 grid gap-6 sm:grid-cols-2">
  <div>
    ...
    <ul className="mt-3 space-y-2">
      {SEED_VOICE_AND_TONE.doList.map((item) => (
  ...
  <div>
    ...
    <ul className="mt-3 space-y-2">
      {SEED_VOICE_AND_TONE.dontList.map((item) => (
        <li key={item} className="text-sm text-muted-foreground">{item}</li>
      ))}
    </ul>
  </div>
